...
exports.getCurrentGoalByUser = exports.createGoal = exports.getGoalCollection = void 0;
...
const getCurrentGoalByUser = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const col = yield (0, exports.getGoalCollection)();
    return col.find({ userId: userId }).sort({ _id: -1 }).limit(1).toArray();
});
exports.getCurrentGoalByUser = getCurrentGoalByUser;
